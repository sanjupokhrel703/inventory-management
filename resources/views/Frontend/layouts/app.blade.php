                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item"> <span
                                        class="text-white dropdown-item-avatar">
                        ...
                        <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                            ...
                            <div class="dropdown-list-content dropdown-list-icons">
                                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                                        ...
                                        class="text-white dropdown-item-icon bg-info"> <i class="far fa-user"></i>
                                    </span> <span class="dropdown-item-desc"> <b>You</b> and <b>Dedik
                                            Sugiharto</b> are now friends <span class="time">10 Hours
                                            Ago</span>
                                    </span>
                                </a> <a href="#" class="dropdown-item"> <span
                                        class="text-white dropdown-item-icon bg-success"> <i class="fas fa-check"></i>
                                        ...
                                        class="text-white dropdown-item-icon bg-danger"> <i
                                            class="fas fa-exclamation-triangle"></i>
                                    </span> <span class="dropdown-item-desc"> Low disk space. Let's
                                        clean it! <span class="time">17 Hours Ago</span>
                                    </span>
                                </a> <a href="#" class="dropdown-item"> <span
                                        class="text-white dropdown-item-icon bg-info"> <i class="fas fa-bell"></i>
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="pie-chart"></i><span>Category</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link" href="{{ route('categories.index') }}">Add Category</a></li>
                                <li><a class="nav-link" href="chart-apexchart.html">apexchart</a></li>
                                <li><a class="nav-link" href="chart-echart.html">eChart</a></li>
                                <li><a class="nav-link" href="chart-chartjs.html">Chartjs</a></li>
                                <li><a class="nav-link" href="chart-sparkline.html">Sparkline</a></li>
                            ...
                            <div class="card ">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="mt-5 row">
                                                <div class="mb-3 col-7 col-xl-7">Total customers</div>
                                                <div class="mb-3 col-5 col-xl-5">
                                                    <span class="text-big">8,257</span>
                                                    <sup class="col-green">+09%</sup>
                                                </div>
                                                <div class="mb-3 col-7 col-xl-7">Total Income</div>
                                                <div class="mb-3 col-5 col-xl-5">
                                                    <span class="text-big">$9,857</span>
                                                    <sup class="text-danger">-18%</sup>
                                                </div>
                                                <div class="mb-3 col-7 col-xl-7">Project completed</div>
                                                <div class="mb-3 col-5 col-xl-5">
                                                    <span class="text-big">28</span>
                                                    <sup class="col-green">+16%</sup>
                                                </div>
                                                <div class="mb-3 col-7 col-xl-7">Total expense</div>
                                                <div class="mb-3 col-5 col-xl-5">
                                                    <span class="text-big">$6,287</span>
                                                    <sup class="col-green">+09%</sup>
                                                </div>
                                                <div class="mb-3 col-7 col-xl-7">New Customers</div>
                                                <div class="mb-3 col-5 col-xl-5">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-12 col-xl-6">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="pb-1 mb-3 support-ticket media">
                                        <img src="assets/img/users/user-1.png" class="mr-2 user-img" alt="">
                                        <div class="ml-3 media-body">
                                            <div class="float-right mb-1 badge badge-pill badge-success">Feature</div>
                                    ...
                                    <div class="pb-1 mb-3 support-ticket media">
                                        <img src="assets/img/users/user-2.png" class="mr-2 user-img" alt="">
                                        <div class="ml-3 media-body">
                                            <div class="float-right mb-1 badge badge-pill badge-warning">Bug</div>
                                    ...
                                    <div class="pb-1 mb-3 support-ticket media">
                                        <img src="assets/img/users/user-3.png" class="mr-2 user-img" alt="">
                                        <div class="ml-3 media-body">
                                            <div class="float-right mb-1 badge badge-pill badge-primary">Query</div>
                                    ...
                                    <div class="pb-1 mb-3 support-ticket media">
                                        <img src="assets/img/users/user-6.png" class="mr-2 user-img" alt="">
                                        <div class="ml-3 media-body">
                                            <div class="float-right mb-1 badge badge-pill badge-info">Enhancement</div>
                                ...
                                <a href="javascript:void(0)" class="text-center card-footer card-link small ">View
                                    All</a>
                            </div>
                            <!-- Support tickets -->
                        </div>
